    ...
    public void InvestigationControlsAreAvailableWithoutClaimingAScan()
    {
        Run(() =>
        {
            ...
            try
            {
                ...
                Assert.IsNull(window.FindName("RuntimeChecksTab"));
                Assert.IsNull(window.FindName("CheckInGameButton"));
                Assert.AreEqual(4, ((TabControl)window.FindName("MainTabControl")).Items.Count);
