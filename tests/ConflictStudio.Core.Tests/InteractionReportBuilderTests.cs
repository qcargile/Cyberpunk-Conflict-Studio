...
public sealed class InteractionReportBuilderTests
{
    ...
    public void BuildSeparatesExclusiveOrderSensitiveAndComposableFindings()
    {
        ...
        Assert.AreEqual(InteractionFindingKind.Exclusive, findings.Single(value => value.Target == "DamageSystem.ProcessHit()").Kind);
        Assert.AreEqual(InteractionFindingKind.Composable, findings.Single(value => value.Target == "PlayerPuppet.OnAction").Kind);
    ...
    public void BuildRequiresReviewWhenAnOverrideCanSuppressTheUnderlyingCall()
    {
        ...
        StringAssert.Contains(finding.Summary, "can stop");
    }
    ...
    public void BuildStatesTheDefinedCetChainAndUnknownCrossModRegistrationOrder()
    {
        ...
        Assert.AreEqual(InteractionFindingKind.Review, finding.Kind);
        StringAssert.Contains(finding.Summary, "registration order");
        Assert.IsFalse(finding.Summary.Contains("does not document", StringComparison.OrdinalIgnoreCase));
    }
